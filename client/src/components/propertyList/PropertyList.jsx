	...
	return (
		<div className="pList">
			<div className="pListItem">
				<img src={hotels} alt="hotels" className="pList" />
			...
			<div className="pListItem">
				<img src={apartamentos} alt="apartamentos" className="pList" />

				<div className="plistTitles">
					<h1>Apartamentos</h1>
					<h2>2303 Apartamentos</h2>
				</div>
			</div>

			<div className="pListItem">
				<img src={resorts} alt="resorts" className="pList" />
			...
			<div className="pListItem">
				<img src={villas} alt="villas" className="pList" />
